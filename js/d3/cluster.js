define( function() {
    ...
    function render(open_stack, on_success_callback){
        $('#chart').empty();
        $('#chart').hide();
    ...
    var nodes = cluster.nodes(open_stack),
    ...
    var node = svg.selectAll(".node")
            ...
            .enter().append("g")
            .attr("class", "node")
        .attr("info", function(d){return d.more_info;})
    ...
    node.append("text")
        ...
        d3.select(self.frameElement).style("height", height + "px");        
                $('#chart').fadeIn(1000, function(){on_success_callback();});
